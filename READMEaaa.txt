...
select *
from data_analyst_jobs       "ExxonMobil"
limit 10

3.	How many postings are in Tennessee? How many are there in either Tennessee or Kentucky?

select count(location)							select count(location)
from data_analyst_jobs							from data_analyst_jobs
	42								where location = 'TN' OR location = 'KY'
									54              
...
from data_analyst_jobs
where no_of_stars > 4 and location = 'TN'     6
...
select count(distinct job_title)  881
from data_analyst_jobs
